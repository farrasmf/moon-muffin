        ...
        <div className="w-full mt-24 px-56">
          <form action="">
            ...
            <div className="flex flex-col gap-2 mb-6">
              ...
              <textarea className="w-full h-80 bg-white border-2 border-[#C9CDC2] rounded-xl p-4 text-xl" id="pesan" name="pesan" value={""} onChange={""} placeholder="Masukan pesan kamu" required />
            </div>
