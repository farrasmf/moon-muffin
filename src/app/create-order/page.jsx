      ...
      <div className="w-full max-w-[1400px] flex flex-col md:flex-row gap-8">
        <div className="flex-1">
          ...
          <div className="w-full md:mt-[8svh] mt-[4svh]">
            <form onSubmit={handleSubmit}>
              <CustomerDetails formData={formData} handleInputChange={handleInputChange} errors={errors} />
              <AccessoryDetails
                formData={formData}
              ...
              {isFormSubmitted && errors.pesanan && <p className="text-red-500 text-center mb-8">{errors.pesanan}</p>}
            </form>
          </div>
        </div>
        ...
        <div className="w-full md:w-[400px] order-last md:order-last">
          <div className="md:sticky md:top-[15svh]">
              ...
              {pesananList.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-8">
                  <svg width="98" height="82" viewBox="0 0 98 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                      ...
                      stroke-linecap="round"
                    />
                    <path d="M58.0239 17.8066C58.8962 34.0985 60.4396 50.4131 62.4508 66.5024" stroke="#C9CDC2" stroke-width="4" stroke-linecap="round" />
                    <path
                ...
                <div className="h-fit max-h-[calc(100vh-50svh)]  overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-track]:my-1 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:border-2 [&::-webkit-scrollbar-thumb]:border-white hover:[&::-webkit-scrollbar-thumb]:bg-gray-300">
                  {pesananList.map((nomor) => {
                    ...
                    const subtotal = jumlahItem * hargaPerItem + thr + biayaPengiriman;

                    return (
                      <div key={nomor} className="mb-6">
                        <h3 className="text-lg text-green-700 mb-3">Pesanan {nomor}</h3>
                        <div className="space-y-2 text-sm text-green-700">
                          <div className="flex justify-between">
                            <span>MoonMuffin Hampers x {jumlahItem} pcs</span>
                            <span>Rp. {(jumlahItem * hargaPerItem).toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between">
            ...
            <button type="submit" onClick={handleSubmit} className="w-full bg-[#92ED00] px-[4svh] py-[2svh] rounded-full font-medium text-[2.8svh] text-[#046511] disabled:opacity-70 disabled:cursor-not-allowed" disabled={isSubmitting}>
