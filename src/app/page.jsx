  ...
  return (
    <div className="min-h-screen bg-[#EDF0E7]">
      ...
      <div className="flex-col flex justify-center items-center py-64 gap-10">
        ...
        <div className="w-full relative">
          <p className="text-2xl text-center">
            ...
            <br />Lihat gimana Moon Muffin bikin momen maaf jadi lebih hangat!
          </p>
          ...
          <img
            ...
            className="absolute top-[1%] right-[27.5%] w-[13%]"
            alt="icon"
          />
      ...
      <div className="flex-col flex justify-center item-center gap-8 mb-32">
        ...
        <div className="w-full relative">
          <p className="text-5xl text-center leading-tight">
            Moon Muffin bukan hampers fancy atau artsy—ini <br />cara sederhana dan tulus buat bilang maaf. Seperti kiriman<br /> dari teman, yang mungkin nggak sempurna, tapi<br /> niatnya serius.
          </p>
          ...
          <img
            src="/assets/icons/highlight-marker-1.svg"
            className="absolute top-[1%] right-[29%] w-[34%]"
            alt="icon"
          />

          <img
            src="/assets/icons/highlight-marker-2.svg"
            className="absolute top-[1%] right-[26%] w-[34%]"
            alt="icon"
          />
          ...
          <img
            ...
            className="absolute bottom-[-3%] right-[42%] "
            alt="icon"
          />
        </div>
        {/* Paragraph 1 End */}
        ...
        <div className="w-full relative">
          <p className="text-5xl text-center leading-tight">
            Nggak perlu kata-kata ribet atau gesture besar, cukup <br /> sesuatu yang manis buat nyampein maksud baik.<br /> Entah buat teman, keluarga, atau siapa pun yang mau<br /> kamu samperin dengan maaf, Moon Muffin ada buat itu<br />—dengan pilihan rasa vanilla, keju, dan coklat yang<br /> siap nemenin permintaan maafmu.
          </p>
          ...
          <img
            ...
            className="absolute bottom-[13%] right-[27.5%] w-[26%]"
            alt="icon"
          />
        ...
        <div className="w-full relative">
          <p className="text-5xl text-center leading-tight">
            Maafnya serius, muffinnya bercanda—tapi yang<br /> penting, pesannya sampai.
          </p>

          <img
            src="/assets/icons/left-quote-icon.svg"
            className="absolute top-[-8%] left-[40%] w-[2%] rotate-45"
            alt="icon"
          />

          <img
            src="/assets/icons/right-quote-icon.svg"
            className="absolute top-[34%] right-[45%] w-[2%] rotate-45"
            alt="icon"
          />

          <img
            src="/assets/icons/orange-maaf-symbol.svg"
            className="absolute bottom-[0%] right-[29%]"
            alt="icon"
          />
      ...
      <div className="min-w-screen pb-36">
        <img
          src="/assets/images/muffin-packaging.png"
      ...
      <div className="relative flex-col flex justify-center items-center gap-10">
        ...
        <div className="w-full relative flex justify-center items-center">
          <button className="bg-[#92ED00] px-8 py-6 rounded-full text-5xl font-medium text-[#046511]">
            Pesan Sekarang!
          </button>
        ...
        <img
          ...
          className="absolute top-36 right-[27%] w-64"
          alt="icon"
        />

        <img
          src="/assets/icons/muffin-word.svg"
          className="absolute top-28 right-[18%] w-44"
          alt="icon"
        />
