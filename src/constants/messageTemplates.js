export const messageTemplates = [
  {
    title: "Heartfelt Missing You",
    template:
      "Hai {nama dia},\n\nAku kangen banget sama kamu. Rasanya ada yang kurang kalau belum ngobrol sama kamu. Semoga kamu baik-baik aja ya. Aku tunggu cerita-cerita baru dari kamu!\n\nMaaf kalau ada yang kurang, moon muffin yaa.\n\nSalam hangat,\n{nama kamu}",
  },
  {
    title: "Fun Banter",
    template:
  ...
  },
  {
    ...
    template:
      "Halo {nama dia}!\n\nUdah berapa lama ya kita ga ketemu? Aku kangen sama obrolan-obrolan kita. Gimana kabarnya? Semoga kamu baik-baik aja ya.\n\nMoon muffin yaa.\n\nXOXO,\n{nama kamu}",
  },
  {
