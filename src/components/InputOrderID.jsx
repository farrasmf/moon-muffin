    ...
    <div className="text-center">
      <h1 className="text-2xl md:text-4xl font-semibold text-green-700 flex items-center justify-center">
        ...
        <svg
          ...
          width="258.000000pt"
          height="108.000000pt"
          viewBox="0 0 258.000000 108.000000"
          preserveAspectRatio="xMidYMid meet"
        >
          <g
            transform="translate(0.000000,108.000000) scale(0.050000,-0.050000)"
            fill="#f77b29"
            stroke="none"
          >
      ...
      <div className="mt-16 flex items-center space-x-2">
        ...
        <div className="border-b h-12 border-gray-700 w-full max-w-sm">
          <input
            ...
            className="w-full text-center text-2xl outline-none bg-transparent placeholder-gray-300 tracking-[0.5em]"
          />
        </div>
        {/* Tombol Submit */}
        <button
          onClick={handleSubmit}
          className="bg-lime-400 text-white p-3 rounded-full hover:bg-lime-500 transition"
        >
          <Image
